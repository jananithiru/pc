...
static void print_numbers(char const * const filename,
		float const * const numbers, size_t const nnumbers) {
	size_t i;
	FILE * fout;
	/* open file */
...
static void read_numbers(char const * const filename, float * const numbers,
		size_t* nnumbers) {
	size_t i = 0;
	FILE * fin;
	int scanresult;
